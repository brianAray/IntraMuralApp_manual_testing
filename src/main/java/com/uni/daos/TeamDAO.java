...
public class TeamDAO implements CrudDAO<Team> {
    ...
    public static TeamDAO getSingleton(HashMap<String, DatabaseStore> data){
    ...
    public Team save(Team team, String devId) {
...
//        }
    ...
    public List<Team> findAll(String devId) {
        DatabaseStore data = null;
        if(database != null){
            data = database.get(devId);
        }
...
//            throw new DatabaseConnectionException();
    ...
    @Override
    public void update(Team team, String devId) {
//        DatabaseStore data = null;
//        if(database != null){
//            data = database.get(devId);
//        }
